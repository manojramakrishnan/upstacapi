...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", userName=" + userName + ", password=" + password + ", created=" + created
				+ ", dateOfBirth=" + dateOfBirth + ", updated=" + updated + ", firstName=" + firstName + ", status="
				+ status + ", email=" + email + ", lastName=" + lastName + ", gender=" + gender + ", phoneNumber="
				+ phoneNumber + ", address=" + address + ", pinCode=" + pinCode + ", roles=" + roles + "]";
	}
